            ...
            <main className="w-full h-screen bg bg-gray-100 p-[1rem] ">
                ...
                <div className="flex h-full">
                    <ul className=" flex flex-row flex-wrap h-[95%] justify-center gap-x-2 gap-y-5 pt-[2rem] overflow-scroll">
                        <li className=" flex-col w-[23%] min-w-[171px] text-center items-center justify-center 	">
                            <img
                        ...
                        <li className=" flex-col w-[23%] min-w-[171px] text-center items-center justify-center 	">
                            <img
                                src="https://images.unsplash.com/photo-1630175860333-5131bda75071?q=80&w=2940&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                                className="rounded-lg"
                                alt=""
                            />
                            Salada
